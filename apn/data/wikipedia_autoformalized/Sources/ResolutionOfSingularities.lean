...
/-- An isomorphism of schemes is birational. -/
@[category API, AMS 14]
theorem IsBirational.of_isIso {W V : Scheme.{u}} (f : W ⟶ V) [IsIso f] : IsBirational f :=
  ⟨⊤, by simp [dense_univ], by simp [dense_univ], inferInstance⟩
