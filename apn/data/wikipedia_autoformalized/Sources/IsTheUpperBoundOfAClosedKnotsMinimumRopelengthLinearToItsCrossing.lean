...
/-- Every closed curve is ambient isotopic to itself, by the constant family of identities. -/
@[category API, AMS 57]
lemma Isotopic.refl (γ : ℝ → ℝ³) : Isotopic γ γ :=
  ⟨fun _ => Homeomorph.refl ℝ³, continuous_snd, rfl, Set.image_id _⟩
