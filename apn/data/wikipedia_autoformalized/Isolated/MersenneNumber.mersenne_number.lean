...
square-free.
-/
theorem mersenne_number : ∀ p : ℕ, p.Prime → Squarefree (mersenne p) := by
  sorry

end MersenneNumber

theorem MersenneNumber.mersenne_number.disproof : ¬ (type_of% @MersenneNumber.mersenne_number) := sorry
