...
theorem HomologicalConjecturesInCommutativeAlgebra.homological_conjectures_in_commutative_algebra.parts.xi.disproof : ¬ (type_of% @HomologicalConjecturesInCommutativeAlgebra.homological_conjectures_in_commutative_algebra.parts.xi) := sorry
