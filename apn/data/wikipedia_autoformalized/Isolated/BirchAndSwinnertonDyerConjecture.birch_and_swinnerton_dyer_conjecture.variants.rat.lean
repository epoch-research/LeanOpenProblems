...
theorem BirchAndSwinnertonDyerConjecture.birch_and_swinnerton_dyer_conjecture.variants.rat.disproof : ¬ (type_of% @BirchAndSwinnertonDyerConjecture.birch_and_swinnerton_dyer_conjecture.variants.rat) := sorry
