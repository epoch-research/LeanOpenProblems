...
theorem InParallelohedron.in_parallelohedron.parts.ii.variants.dim_five.disproof : ¬ (type_of% @InParallelohedron.in_parallelohedron.parts.ii.variants.dim_five) := sorry
