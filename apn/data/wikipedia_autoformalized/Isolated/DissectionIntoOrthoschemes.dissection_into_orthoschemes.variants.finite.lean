...
theorem dissection_into_orthoschemes.variants.finite :
    ∀ (d : ℕ) (S : Simplex ℝ (ℝ^d) d),
      ∃ n, IsDissectableIntoOrthoschemes n S := by
  sorry

end DissectionIntoOrthoschemes

theorem DissectionIntoOrthoschemes.dissection_into_orthoschemes.variants.finite.disproof : ¬ (type_of% @DissectionIntoOrthoschemes.dissection_into_orthoschemes.variants.finite) := sorry
