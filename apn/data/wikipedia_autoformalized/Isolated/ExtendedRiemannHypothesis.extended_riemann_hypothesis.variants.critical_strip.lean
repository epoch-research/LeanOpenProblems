...
theorem ExtendedRiemannHypothesis.extended_riemann_hypothesis.variants.critical_strip.disproof : ¬ (type_of% @ExtendedRiemannHypothesis.extended_riemann_hypothesis.variants.critical_strip) := sorry
