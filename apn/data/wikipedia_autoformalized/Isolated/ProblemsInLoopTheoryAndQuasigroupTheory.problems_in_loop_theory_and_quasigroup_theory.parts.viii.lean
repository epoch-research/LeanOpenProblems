...
theorem problems_in_loop_theory_and_quasigroup_theory.parts.viii :
    ∃ (Q : Type) (_ : Loop Q), Finite Q ∧ IsUniversallyFlexible Q ∧
      ¬ IsMiddleBol Q := by
  sorry
...
theorem ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.viii.disproof : ¬ (type_of% @ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.viii) := sorry
