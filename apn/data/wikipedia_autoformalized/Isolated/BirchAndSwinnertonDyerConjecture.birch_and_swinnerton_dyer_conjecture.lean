...
theorem BirchAndSwinnertonDyerConjecture.birch_and_swinnerton_dyer_conjecture.disproof : ¬ (type_of% @BirchAndSwinnertonDyerConjecture.birch_and_swinnerton_dyer_conjecture) := sorry
