...
theorem problems_in_loop_theory_and_quasigroup_theory.parts.vii.variants.bol :
    IsQuadraticClass fun Q L => @IsLeftBol Q L := by
  sorry
...
theorem ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.vii.variants.bol.disproof : ¬ (type_of% @ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.vii.variants.bol) := sorry
