...
theorem CanEverySphericalNonConvexPolyhedronThatTilesSpaceByTranslationHaveI.can_every_spherical_non_convex_polyhedron_that_tiles_space_by_translation_have_i.disproof : ¬ (type_of% @CanEverySphericalNonConvexPolyhedronThatTilesSpaceByTranslationHaveI.can_every_spherical_non_convex_polyhedron_that_tiles_space_by_translation_have_i) := sorry
