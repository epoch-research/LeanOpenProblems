...
theorem UnfriendlyPartitionConjecture.unfriendly_partition_conjecture.disproof : ¬ (type_of% @UnfriendlyPartitionConjecture.unfriendly_partition_conjecture) := sorry
