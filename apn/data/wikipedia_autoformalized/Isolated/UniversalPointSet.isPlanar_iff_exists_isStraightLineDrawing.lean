...
theorem UniversalPointSet.isPlanar_iff_exists_isStraightLineDrawing.disproof : ¬ (type_of% @UniversalPointSet.isPlanar_iff_exists_isStraightLineDrawing) := sorry
