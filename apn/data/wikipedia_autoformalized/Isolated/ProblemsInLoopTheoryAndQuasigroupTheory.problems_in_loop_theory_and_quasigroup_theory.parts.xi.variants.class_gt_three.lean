...
theorem problems_in_loop_theory_and_quasigroup_theory.parts.xi.variants.class_gt_three :
    ∃ (Q : Type) (_ : Loop Q), IsMulCommutative (innerMappingGroup Q) ∧
...
theorem ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.xi.variants.class_gt_three.disproof : ¬ (type_of% @ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.xi.variants.class_gt_three) := sorry
