...
theorem CoveringProblemOfRado.covering_problem_of_rado.variants.rado_conjecture.disproof : ¬ (type_of% @CoveringProblemOfRado.covering_problem_of_rado.variants.rado_conjecture) := sorry
