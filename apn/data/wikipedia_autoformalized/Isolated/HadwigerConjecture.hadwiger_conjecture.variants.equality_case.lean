...
theorem HadwigerConjecture.hadwiger_conjecture.variants.equality_case.disproof : ¬ (type_of% @HadwigerConjecture.hadwiger_conjecture.variants.equality_case) := sorry
