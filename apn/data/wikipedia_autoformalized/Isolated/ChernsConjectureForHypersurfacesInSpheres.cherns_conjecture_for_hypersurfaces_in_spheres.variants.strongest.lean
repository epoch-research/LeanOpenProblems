...
theorem ChernsConjectureForHypersurfacesInSpheres.cherns_conjecture_for_hypersurfaces_in_spheres.variants.strongest.disproof : ¬ (type_of% @ChernsConjectureForHypersurfacesInSpheres.cherns_conjecture_for_hypersurfaces_in_spheres.variants.strongest) := sorry
