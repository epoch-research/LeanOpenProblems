...
theorem FirstMoveAdvantageInChess.first_move_advantage_in_chess.variants.draw.disproof : ¬ (type_of% @FirstMoveAdvantageInChess.first_move_advantage_in_chess.variants.draw) := sorry
