...
theorem HardyLittlewoodZetaFunctionConjectures.hardy_littlewood_zeta_function_conjectures.parts.ii.disproof : ¬ (type_of% @HardyLittlewoodZetaFunctionConjectures.hardy_littlewood_zeta_function_conjectures.parts.ii) := sorry
