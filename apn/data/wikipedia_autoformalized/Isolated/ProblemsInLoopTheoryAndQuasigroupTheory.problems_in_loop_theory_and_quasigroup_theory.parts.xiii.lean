...
theorem problems_in_loop_theory_and_quasigroup_theory.parts.xiii :
    ∃ (Q : Type) (_ : Loop Q), Finite Q ∧ IsSimple Q ∧ IsAutomorphic Q ∧
      ¬ IsAssociative Q := by
  sorry
...
theorem ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.xiii.disproof : ¬ (type_of% @ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.xiii) := sorry
