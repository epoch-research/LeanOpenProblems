...
theorem DiskCoveringProblem.disk_covering_problem.variants.eleven_lower_bound.disproof : ¬ (type_of% @DiskCoveringProblem.disk_covering_problem.variants.eleven_lower_bound) := sorry
