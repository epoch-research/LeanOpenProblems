...
theorem CoveringProblemOfRado.covering_problem_of_rado.variants.bereg_dumitrescu_jiang_upper_bound.disproof : ¬ (type_of% @CoveringProblemOfRado.covering_problem_of_rado.variants.bereg_dumitrescu_jiang_upper_bound) := sorry
