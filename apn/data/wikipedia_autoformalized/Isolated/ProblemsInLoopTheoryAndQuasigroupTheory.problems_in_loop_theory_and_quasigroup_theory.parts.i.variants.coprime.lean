...
theorem problems_in_loop_theory_and_quasigroup_theory.parts.i.variants.coprime :
    ∀ (L : Type*) [Loop L] [IsMoufang L] (M : Subloop L), M.IsNormal →
...
theorem ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.i.variants.coprime.disproof : ¬ (type_of% @ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.i.variants.coprime) := sorry
