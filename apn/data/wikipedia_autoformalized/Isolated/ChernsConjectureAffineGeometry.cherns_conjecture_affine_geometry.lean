...
theorem ChernsConjectureAffineGeometry.cherns_conjecture_affine_geometry.disproof : ¬ (type_of% @ChernsConjectureAffineGeometry.cherns_conjecture_affine_geometry) := sorry
