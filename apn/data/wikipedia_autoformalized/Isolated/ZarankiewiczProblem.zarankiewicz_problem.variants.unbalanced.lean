...
theorem ZarankiewiczProblem.zarankiewicz_problem.variants.unbalanced.disproof : ¬ (type_of% @ZarankiewiczProblem.zarankiewicz_problem.variants.unbalanced) := sorry
