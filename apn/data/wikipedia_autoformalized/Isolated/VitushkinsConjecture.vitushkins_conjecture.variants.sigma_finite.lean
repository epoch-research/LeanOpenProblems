...
theorem VitushkinsConjecture.vitushkins_conjecture.variants.sigma_finite.disproof : ¬ (type_of% @VitushkinsConjecture.vitushkins_conjecture.variants.sigma_finite) := sorry
