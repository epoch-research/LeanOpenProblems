...
theorem NConjecture.n_conjecture.variants.strong_lower_bound_holzl_kleine_stephan.disproof : ¬ (type_of% @NConjecture.n_conjecture.variants.strong_lower_bound_holzl_kleine_stephan) := sorry
