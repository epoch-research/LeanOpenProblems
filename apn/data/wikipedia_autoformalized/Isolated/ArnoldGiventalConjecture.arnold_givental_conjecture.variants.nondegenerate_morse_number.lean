...
theorem ArnoldGiventalConjecture.arnold_givental_conjecture.variants.nondegenerate_morse_number.disproof : ¬ (type_of% @ArnoldGiventalConjecture.arnold_givental_conjecture.variants.nondegenerate_morse_number) := sorry
