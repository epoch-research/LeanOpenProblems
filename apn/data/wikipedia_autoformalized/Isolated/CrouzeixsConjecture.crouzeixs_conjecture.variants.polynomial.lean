...
theorem CrouzeixsConjecture.crouzeixs_conjecture.variants.polynomial.disproof : ¬ (type_of% @CrouzeixsConjecture.crouzeixs_conjecture.variants.polynomial) := sorry
