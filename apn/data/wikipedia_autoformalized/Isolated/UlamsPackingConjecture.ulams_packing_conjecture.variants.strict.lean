...
theorem UlamsPackingConjecture.ulams_packing_conjecture.variants.strict.disproof : ¬ (type_of% @UlamsPackingConjecture.ulams_packing_conjecture.variants.strict) := sorry
