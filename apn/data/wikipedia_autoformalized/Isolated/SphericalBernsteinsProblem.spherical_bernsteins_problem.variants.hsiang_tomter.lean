...
theorem SphericalBernsteinsProblem.spherical_bernsteins_problem.variants.hsiang_tomter.disproof : ¬ (type_of% @SphericalBernsteinsProblem.spherical_bernsteins_problem.variants.hsiang_tomter) := sorry
