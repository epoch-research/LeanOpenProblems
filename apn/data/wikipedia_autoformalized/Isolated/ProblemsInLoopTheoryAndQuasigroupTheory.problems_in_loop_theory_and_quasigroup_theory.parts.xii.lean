...
theorem problems_in_loop_theory_and_quasigroup_theory.parts.xii :
    ∃ (Q : Type) (_ : Loop Q), Finite Q ∧ Loop.IsNilpotent Q ∧
...
theorem ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.xii.disproof : ¬ (type_of% @ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.xii) := sorry
