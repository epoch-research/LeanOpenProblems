...
theorem OpaqueForestProblem.opaque_forest_problem.variants.equilateral_triangle.disproof : ¬ (type_of% @OpaqueForestProblem.opaque_forest_problem.variants.equilateral_triangle) := sorry
