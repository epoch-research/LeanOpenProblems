...
theorem DeBruijnNewmanConstant.existsUnique_isDeBruijnNewmanConstant.disproof : ¬ (type_of% @DeBruijnNewmanConstant.existsUnique_isDeBruijnNewmanConstant) := sorry
