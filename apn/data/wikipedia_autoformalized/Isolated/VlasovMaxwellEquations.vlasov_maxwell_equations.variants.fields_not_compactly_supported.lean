...
theorem VlasovMaxwellEquations.vlasov_maxwell_equations.variants.fields_not_compactly_supported.disproof : ¬ (type_of% @VlasovMaxwellEquations.vlasov_maxwell_equations.variants.fields_not_compactly_supported) := sorry
