...
theorem ReinhardtsConjecture.reinhardts_conjecture.variants.lattice.disproof : ¬ (type_of% @ReinhardtsConjecture.reinhardts_conjecture.variants.lattice) := sorry
