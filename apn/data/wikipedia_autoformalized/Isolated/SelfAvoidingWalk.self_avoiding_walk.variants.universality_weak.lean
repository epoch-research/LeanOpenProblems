...
theorem SelfAvoidingWalk.self_avoiding_walk.variants.universality_weak.disproof : ¬ (type_of% @SelfAvoidingWalk.self_avoiding_walk.variants.universality_weak) := sorry
