...
theorem HomologicalConjecturesInCommutativeAlgebra.homological_conjectures_in_commutative_algebra.parts.xiii.disproof : ¬ (type_of% @HomologicalConjecturesInCommutativeAlgebra.homological_conjectures_in_commutative_algebra.parts.xiii) := sorry
