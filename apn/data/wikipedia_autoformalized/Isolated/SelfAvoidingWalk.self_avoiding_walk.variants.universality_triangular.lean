...
theorem SelfAvoidingWalk.self_avoiding_walk.variants.universality_triangular.disproof : ¬ (type_of% @SelfAvoidingWalk.self_avoiding_walk.variants.universality_triangular) := sorry
