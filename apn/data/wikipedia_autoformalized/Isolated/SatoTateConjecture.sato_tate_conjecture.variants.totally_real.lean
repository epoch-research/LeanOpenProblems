...
theorem SatoTateConjecture.sato_tate_conjecture.variants.totally_real.disproof : ¬ (type_of% @SatoTateConjecture.sato_tate_conjecture.variants.totally_real) := sorry
