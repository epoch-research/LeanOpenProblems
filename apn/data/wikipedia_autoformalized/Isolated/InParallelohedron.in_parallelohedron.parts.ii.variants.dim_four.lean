...
theorem InParallelohedron.in_parallelohedron.parts.ii.variants.dim_four.disproof : ¬ (type_of% @InParallelohedron.in_parallelohedron.parts.ii.variants.dim_four) := sorry
