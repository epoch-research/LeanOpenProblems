...
theorem more_than_seven_faces :
    ∃ faces : Finset (Set ℝ³), 7 < faces.card ∧ IsPolyhedron faces ∧
...
theorem MoreThanSevenFaces.more_than_seven_faces.disproof : ¬ (type_of% @MoreThanSevenFaces.more_than_seven_faces) := sorry
