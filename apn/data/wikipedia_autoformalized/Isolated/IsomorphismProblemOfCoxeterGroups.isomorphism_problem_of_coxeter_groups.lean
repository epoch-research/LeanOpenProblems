...
theorem IsomorphismProblemOfCoxeterGroups.isomorphism_problem_of_coxeter_groups.disproof : ¬ (type_of% @IsomorphismProblemOfCoxeterGroups.isomorphism_problem_of_coxeter_groups) := sorry
