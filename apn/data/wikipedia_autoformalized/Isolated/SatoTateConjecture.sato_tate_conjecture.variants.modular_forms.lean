...
theorem SatoTateConjecture.sato_tate_conjecture.variants.modular_forms.disproof : ¬ (type_of% @SatoTateConjecture.sato_tate_conjecture.variants.modular_forms) := sorry
