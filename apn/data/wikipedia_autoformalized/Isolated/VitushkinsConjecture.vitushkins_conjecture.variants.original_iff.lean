...
theorem VitushkinsConjecture.vitushkins_conjecture.variants.original_iff.disproof : ¬ (type_of% @VitushkinsConjecture.vitushkins_conjecture.variants.original_iff) := sorry
