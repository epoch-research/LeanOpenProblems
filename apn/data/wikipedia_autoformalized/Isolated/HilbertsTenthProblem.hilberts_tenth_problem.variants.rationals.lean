...
theorem hilberts_tenth_problem.variants.rationals :
    ComputablePred fun p : PolyCode ℚ => p.HasSolution id := by
  sorry

end HilbertsTenthProblem

theorem HilbertsTenthProblem.hilberts_tenth_problem.variants.rationals.disproof : ¬ (type_of% @HilbertsTenthProblem.hilberts_tenth_problem.variants.rationals) := sorry
