...
theorem CoveringProblemOfRado.covering_problem_of_rado.variants.congruent_squares.disproof : ¬ (type_of% @CoveringProblemOfRado.covering_problem_of_rado.variants.congruent_squares) := sorry
