...
theorem HomologicalConjecturesInCommutativeAlgebra.homological_conjectures_in_commutative_algebra.parts.viii.disproof : ¬ (type_of% @HomologicalConjecturesInCommutativeAlgebra.homological_conjectures_in_commutative_algebra.parts.viii) := sorry
