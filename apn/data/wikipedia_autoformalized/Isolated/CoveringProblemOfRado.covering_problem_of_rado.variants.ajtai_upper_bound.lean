...
theorem CoveringProblemOfRado.covering_problem_of_rado.variants.ajtai_upper_bound.disproof : ¬ (type_of% @CoveringProblemOfRado.covering_problem_of_rado.variants.ajtai_upper_bound) := sorry
