...
-/
theorem tuzas_conjecture.variants.hittingNumber : 
...
theorem TuzasConjecture.tuzas_conjecture.variants.hittingNumber.disproof : ¬ (type_of% @TuzasConjecture.tuzas_conjecture.variants.hittingNumber) := sorry
