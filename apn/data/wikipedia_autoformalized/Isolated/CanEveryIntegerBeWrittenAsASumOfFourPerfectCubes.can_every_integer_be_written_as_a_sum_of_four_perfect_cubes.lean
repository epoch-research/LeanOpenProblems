...
theorem can_every_integer_be_written_as_a_sum_of_four_perfect_cubes :
    ∀ n : ℤ, ∃ a b c d : ℤ, n = a ^ 3 + b ^ 3 + c ^ 3 + d ^ 3 := by
  sorry

end CanEveryIntegerBeWrittenAsASumOfFourPerfectCubes

theorem CanEveryIntegerBeWrittenAsASumOfFourPerfectCubes.can_every_integer_be_written_as_a_sum_of_four_perfect_cubes.disproof : ¬ (type_of% @CanEveryIntegerBeWrittenAsASumOfFourPerfectCubes.can_every_integer_be_written_as_a_sum_of_four_perfect_cubes) := sorry
