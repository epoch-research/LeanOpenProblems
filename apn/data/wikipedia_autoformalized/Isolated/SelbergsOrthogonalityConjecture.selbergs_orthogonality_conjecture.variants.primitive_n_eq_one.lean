...
theorem SelbergsOrthogonalityConjecture.selbergs_orthogonality_conjecture.variants.primitive_n_eq_one.disproof : ¬ (type_of% @SelbergsOrthogonalityConjecture.selbergs_orthogonality_conjecture.variants.primitive_n_eq_one) := sorry
