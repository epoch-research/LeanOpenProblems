...
theorem ReconstructionConjecture.reconstruction_conjecture.parts.ii.disproof : ¬ (type_of% @ReconstructionConjecture.reconstruction_conjecture.parts.ii) := sorry
