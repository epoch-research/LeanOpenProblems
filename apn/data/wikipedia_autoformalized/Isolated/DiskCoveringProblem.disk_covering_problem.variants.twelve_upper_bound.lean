...
theorem DiskCoveringProblem.disk_covering_problem.variants.twelve_upper_bound.disproof : ¬ (type_of% @DiskCoveringProblem.disk_covering_problem.variants.twelve_upper_bound) := sorry
