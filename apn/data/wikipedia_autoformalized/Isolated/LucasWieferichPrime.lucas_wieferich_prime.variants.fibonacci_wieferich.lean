...
theorem lucas_wieferich_prime.variants.fibonacci_wieferich :
    {p : ℕ | IsLucasWieferichPrime 1 (-1) p}.Infinite := by
  sorry

end LucasWieferichPrime

theorem LucasWieferichPrime.lucas_wieferich_prime.variants.fibonacci_wieferich.disproof : ¬ (type_of% @LucasWieferichPrime.lucas_wieferich_prime.variants.fibonacci_wieferich) := sorry
