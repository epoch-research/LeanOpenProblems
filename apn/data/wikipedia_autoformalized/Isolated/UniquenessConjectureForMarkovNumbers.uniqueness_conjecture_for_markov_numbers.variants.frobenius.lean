...
theorem UniquenessConjectureForMarkovNumbers.uniqueness_conjecture_for_markov_numbers.variants.frobenius.disproof : ¬ (type_of% @UniquenessConjectureForMarkovNumbers.uniqueness_conjecture_for_markov_numbers.variants.frobenius) := sorry
