...
theorem SingularCardinalsHypothesis.singular_cardinals_hypothesis.variants.shelah_bound.disproof : ¬ (type_of% @SingularCardinalsHypothesis.singular_cardinals_hypothesis.variants.shelah_bound) := sorry
