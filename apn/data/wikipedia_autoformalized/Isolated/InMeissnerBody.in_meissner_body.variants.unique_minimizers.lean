...
theorem in_meissner_body.variants.unique_minimizers :
    ∀ w : ℝ, 0 < w → ∀ K : ConvexBody ℝ³, HasConstantWidth K w →
...
theorem InMeissnerBody.in_meissner_body.variants.unique_minimizers.disproof : ¬ (type_of% @InMeissnerBody.in_meissner_body.variants.unique_minimizers) := sorry
