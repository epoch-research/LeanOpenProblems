...
theorem DiskCoveringProblem.disk_covering_problem.variants.central_disk_layouts.disproof : ¬ (type_of% @DiskCoveringProblem.disk_covering_problem.variants.central_disk_layouts) := sorry
