...
theorem DiskCoveringProblem.disk_covering_problem.variants.twelve_lower_bound.disproof : ¬ (type_of% @DiskCoveringProblem.disk_covering_problem.variants.twelve_lower_bound) := sorry
