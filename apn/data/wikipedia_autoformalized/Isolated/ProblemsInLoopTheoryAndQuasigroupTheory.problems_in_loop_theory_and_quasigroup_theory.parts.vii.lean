...
theorem problems_in_loop_theory_and_quasigroup_theory.parts.vii :
    IsQuadraticClass fun Q L => @IsMoufang Q L := by
  sorry
...
theorem ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.vii.disproof : ¬ (type_of% @ProblemsInLoopTheoryAndQuasigroupTheory.problems_in_loop_theory_and_quasigroup_theory.parts.vii) := sorry
