...
theorem ChernsConjectureForHypersurfacesInSpheres.cherns_conjecture_for_hypersurfaces_in_spheres.disproof : ¬ (type_of% @ChernsConjectureForHypersurfacesInSpheres.cherns_conjecture_for_hypersurfaces_in_spheres) := sorry
