...
theorem DeBruijnNewmanConstant.de_bruijn_newman_constant.variants.eq_zero.disproof : ¬ (type_of% @DeBruijnNewmanConstant.de_bruijn_newman_constant.variants.eq_zero) := sorry
