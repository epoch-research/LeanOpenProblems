...
theorem HilbertsThirdProblemForNonEuclideanGeometries.hilberts_third_problem_for_non_euclidean_geometries.parts.ii.disproof : ¬ (type_of% @HilbertsThirdProblemForNonEuclideanGeometries.hilberts_third_problem_for_non_euclidean_geometries.parts.ii) := sorry
