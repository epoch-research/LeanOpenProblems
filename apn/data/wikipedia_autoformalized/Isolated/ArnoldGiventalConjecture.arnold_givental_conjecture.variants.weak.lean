...
theorem ArnoldGiventalConjecture.arnold_givental_conjecture.variants.weak.disproof : ¬ (type_of% @ArnoldGiventalConjecture.arnold_givental_conjecture.variants.weak) := sorry
