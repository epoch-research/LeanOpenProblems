...
theorem ConverseOfWolstenholmesTheorem.converse_of_wolstenholmes_theorem.disproof : ¬ (type_of% @ConverseOfWolstenholmesTheorem.converse_of_wolstenholmes_theorem) := sorry
