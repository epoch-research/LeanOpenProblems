...
theorem SidorenkoConjecture.tournament_anti_sidorenko_trees_conjecture.disproof : ¬ (type_of% @SidorenkoConjecture.tournament_anti_sidorenko_trees_conjecture) := sorry
